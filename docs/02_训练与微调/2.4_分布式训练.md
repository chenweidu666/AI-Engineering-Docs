<p align="center"><strong>分布式训练</strong></p>



> **关键词**：DDP · FSDP · DeepSpeed · ZeRO · 流水线并行 · 张量并行

<h1 align="center">为什么需要分布式训练</h1>

<h1 align="center">并行策略</h1>
## 数据并行（DDP）
## 张量并行（TP）
## 流水线并行（PP）
## 序列并行

<h1 align="center">DeepSpeed ZeRO</h1>
## ZeRO-1/2/3 对比
## Offload策略

<h1 align="center">FSDP vs DeepSpeed</h1>

<h1 align="center">多机多卡配置实战</h1>
...
<h1 align="center">📎 参考资料：分布式训练框架综述</h1>
...
---
<h1 align="center">1 Megatron-LM</h1>
...
<h1 align="center">2 DeepSpeed</h1>
...
---
<h1 align="center">主流微调框架技术对比</h1>

<h1 align="center">1 微调方法支持</h1>
...
<h1 align="center">2 Megatron-LM 实现步骤</h1>
```bash
#!/bin/bash
# 1. 环境准备
...
<h1 align="center">3 DeepSpeed 实现步骤</h1>
```python
# 1. 环境准备
...
<h1 align="center">4 Hugging Face PEFT 实现步骤（M4 环境）</h1>
```python
