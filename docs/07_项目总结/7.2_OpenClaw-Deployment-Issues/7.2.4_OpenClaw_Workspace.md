...
<div style="text-align: center; font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem;"><strong>OpenClaw 自定义 Workspace：让 AI 有灵魂</strong></div>

本文档从 [README 主文档](../README.md) 中独立出来，详细介绍如何通过 Workspace 文件定义 AI 的人格、身份和能力边界。

相关文档：[Skill 开发指南](./7.2.5_OpenClaw_Skills.md)


# 1. 目录


- [1. Workspace 概述](#2-workspace-概述)
- [2. SOUL.md — 定义人格](#3-soulmd--定义人格)
- [3. IDENTITY.md — 身份卡片](#4-identitymd--身份卡片)
- [4. TOOLS.md — 工具能力备忘（关键文件！）](#5-toolsmd--工具能力备忘关键文件)
- [5. 记忆系统 — MEMORY.md + 每日日志](#6-记忆系统--memorymd--每日日志)
