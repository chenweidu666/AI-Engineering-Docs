...
#### 1.13.2.3. 步骤 3：安装 PyTorch（根据 CUDA 版本选择）
...
#### 1.13.4.1. 问题 1：CUDA 版本不匹配（Linux）
...
#### 1.13.4.3. 问题 3：llm-compressor 找不到
...
#### 1.18.3.1. Q1: llm-compressor 和 GPTQ、AWQ 有什么区别？
...
#### 1.18.3.6. Q6: 量化过程中如何选择 per-tensor 还是 per-channel？
...
#### 1.18.3.7. Q7: 量化后的模型在不同硬件上的性能差异大吗？
...
#### 1.18.3.8. Q8: 如何处理量化后的模型在不同 batch size 下的性能？
...
#### 1.20.1.1. Q11: 量化过程中的 Round-to-Nearest (RTN) 和 GPTQ 的区别是什么？
...
#### 1.20.1.2. Q12: 量化中的对称量化和非对称量化如何选择？
...
#### 1.20.1.3. Q13: 量化中的 Calibration 过程具体是怎么做的？
...
#### 1.20.1.4. Q14: 量化误差是如何累积的？如何减少误差累积？
...
### 1.20.2. 5 项目经验描述模板（STAR 法则）

#### 1.20.2.1. 模板 1：量化项目整体描述
...
#### 1.20.3.1. Q15: 如何设计一个支持多种量化方案的量化服务？
