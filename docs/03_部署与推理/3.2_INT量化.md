<p align="center"><strong>INT4/INT8 量化实战</strong></p>



> **关键词**：GPTQ · AWQ · SmoothQuant · bitsandbytes · 敏感层

<h1 align="center">为什么量化</h1>

<h1 align="center">量化基础</h1>
## FP32→FP16→INT8→INT4
## 对称 vs 非对称量化

<h1 align="center">主流量化方案对比</h1>
| 方案 | 原理 | 精度损失 | 速度 |
|------|------|---------|------|
| GPTQ | 逐层离线量化 | 小 | 快 |
| AWQ | 激活感知权重 | 更小 | 快 |
...
<h1 align="center">敏感层保护（FP16 fallback）</h1>

<h1 align="center">vLLM中量化配置实战</h1>

<h1 align="center">实测：太初项目量化收益</h1>
- 显存：−50%+
- 吞吐：↑明显
- 精度：可接受
...
<h1 align="center">📎 参考资料：LLM压缩工具介绍</h1>

<h1 align="center">llm-compressor 大模型量化工具详解</h1>
...
<h1 align="center">llm-compressor 是什么？</h1>
