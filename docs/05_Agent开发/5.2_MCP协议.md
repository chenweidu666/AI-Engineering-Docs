...
> **导航**：[← 5.1 Agent 设计](5.1_Agent设计与工作流.md) · [下一节：5.3 Dify →](5.3_Dify工作流平台.md)

> **本章导读**：MCP 把「工具与上下文」从各应用重复集成，收敛为 **可复用的 Server + 标准 JSON-RPC**。读完正文可掌握概念边界与接入步骤；**架构图、场景拆解与面试要点**见文末附录。
