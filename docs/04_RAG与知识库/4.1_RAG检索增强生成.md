<p align="center"><strong>RAG 检索增强生成</strong></p>



> **关键词**：RAG · 文档切块 · 向量化 · 混合检索 · 重排序 · 生成

<h1 align="center">为什么需要RAG</h1>

<h1 align="center">RAG完整流程</h1>
## 文档加载与解析（PaddleOCR）
## 文档切块策略
## 向量化（Embedding模型）
## 向量存储（Milvus）
...
<h1 align="center">混合检索</h1>
- 向量检索（语义相似度）
- 关键词检索（BM25）
- 融合策略（RRF / 加权）

<h1 align="center">重排序（Rerank）</h1>
- BGE-Reranker
- Cross-encoder原理

<h1 align="center">太初项目实战数据</h1>
- 5+行业，百万级知识库
- 问答准确率↑30%
- 响应时间≤1s
...
<h1 align="center">📎 参考资料：RAG流程与面试问题整理</h1>

<h1 align="center">RAG（Retrieval-Augmented Generation）流程概述</h1>
...
<h1 align="center">知识库构建阶段（Offline Preparation）</h1>
...
<h1 align="center">在线查询阶段（Online Querying）</h1>
...
<h1 align="center">如何提升 RAG 召回率</h1>
...
<h1 align="center">RAG 面试问题（补充召回率相关）</h1>
...
<h1 align="center">代码示例（LangChain + FAISS）</h1>
...
<h1 align="center">📎 参考资料：RAG问答系统设计与实现</h1>

<h1 align="center">RAG 问答系统 - 基于 PDF 的智能问答工具</h1>
