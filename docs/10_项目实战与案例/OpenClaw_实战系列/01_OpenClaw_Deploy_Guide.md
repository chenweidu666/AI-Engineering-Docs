...
<div style="text-align: center; font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem;"><strong>OpenClaw 环境构建与 API 配置</strong></div>
...
- [1. 为什么选 OpenClaw？](#2-为什么选-openclaw)
- [2. 硬件与系统准备](#3-硬件与系统准备)
- [3. 安装 OpenClaw](#4-安装-openclaw)
- [4. 接入阿里云 Qwen3 大模型](#5-接入阿里云-qwen3-大模型)
- [5. Nginx HTTPS：局域网 Web UI 访问](#6-nginx-https局域网-web-ui-访问)（[独立文档](./7.2.3_OpenClaw_Nginx_WebUI.md)）
...
> 这一章是为 OpenClaw 准备运行环境。如果你已经有一台 Linux 服务器或 VPS，可以直接跳到 [第 4 节：安装 OpenClaw](#4-安装-openclaw)。

## 3.1. 我的硬件：绿联 DH4300+ NAS
...
> 详细内容已独立成文档，详见：**[Nginx HTTPS 配置指南](./7.2.3_OpenClaw_Nginx_WebUI.md)**
...
> 环境部署完成！接下来可以继续：
>
> - [Workspace 自定义指南](./7.2.4_OpenClaw_Workspace.md) — 定义 AI 人格、身份和能力
> - [Skill 开发指南](./7.2.5_OpenClaw_Skills.md) — 给 AI 增加自定义能力
> - [踩坑记录与实践](./7.2.2_OpenClaw_Pitfalls_and_Practices.md#踩坑记录) — 17 则案例与最佳实践
> - [安全与时间线复盘](./7.2.7_OpenClaw_Security_and_Retrospective.md) — 部署里程碑、功能总览、Token 评估
> - 返回 [项目总览](../README.md)

---

> **文档最近修订**：2026-03-23（导航补充 7.2.2 / 7.2.7；选型表「部署方式」与 Docker 表述对齐）
