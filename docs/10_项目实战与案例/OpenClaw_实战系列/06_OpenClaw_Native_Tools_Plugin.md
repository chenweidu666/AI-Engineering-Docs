...
<div style="text-align: center; font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem;"><strong>OpenClaw 原生工具插件开发：从上下文依赖到 Function Calling</strong></div>
...
- [1. 为什么需要原生工具](#2-为什么需要原生工具)
  - [1.1 Skill 系统的问题](#21-skill-系统的问题)
  - [1.2 nativeSkills 的误解](#22-nativeskills-的误解)
  - [1.3 原生工具方案](#23-原生工具方案)
- [2. 插件架构](#3-插件架构)
  - [2.1 整体原理](#31-整体原理)
  - [2.2 文件结构](#32-文件结构)
  - [2.3 Skill vs Plugin Tool 对比](#33-skill-vs-plugin-tool-对比)
- [3. 开发指南](#4-开发指南)
  - [3.1 插件清单 (openclaw.plugin.json)](#41-插件清单)
  - [3.2 工具注册 (index.ts)](#42-工具注册)
  - [3.3 工具参数设计](#43-工具参数设计)
  - [3.4 执行脚本与返回结果](#44-执行脚本与返回结果)
- [4. 配置与部署](#5-配置与部署)
  - [4.1 加载路径配置](#51-加载路径配置)
  - [4.2 重启与验证](#52-重启与验证)
  - [4.3 调试技巧](#53-调试技巧)
- [5. 实战：5 个原生工具](#6-实战5-个原生工具)
  - [5.1 cw_system_info — 系统信息](#62-cw_system_info--系统信息)
  - [5.2 cw_weather — 天气查询（已关闭）](#63-cw_weather--天气查询已关闭)
  - [5.3 cw_nas_search — NAS 深度搜索（已关闭）](#64-cw_nas_search--nas-深度搜索已关闭)
  - [5.4 cw_bilibili_summary — B站视频转写+总结（已关闭）](#65-cw_bilibili_summary--b站视频转写总结已关闭)
  - [5.5 cw_qwen_billing — API 费用查询（已关闭）](#66-cw_qwen_billing--api-费用查询已关闭)
- [6. 注意事项与踩坑](#7-注意事项与踩坑)
